...
public class SimViewer extends javax.swing.JFrame {
    ...
    private void TerminateSimButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TerminateSimButtonActionPerformed
        // TODO add your handling code here:
        stopStatus = true;
        TerminateSimButton.setEnabled(false);
    }//GEN-LAST:event_TerminateSimButtonActionPerformed
    
    private void setBarsValue(int value){
        RockPercent.setValue(value);
        PaperPercent.setValue(value);
        ScissorPercent.setValue(value);
    }
    ...
    public void setImagee(BufferedImage img) {
        //MainWindow.setIcon(new ImageIcon(img.getScaledInstance(720, 720, Image.SCALE_SMOOTH)));
    }
